...
def main():
    try:
        ...
        send_notification(['1', '311'], 'Работа вечерних процессов прервана на завершении дел со звонками')
    try:
        update_daily_task_statistic()
    except:
        send_notification(['1', '311'], 'Работа вечерних процессов прервана на обновлении отчета по задачам')
    try:
